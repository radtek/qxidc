...
int sqlstatement::prepare(char *fmt,...)
{
  ...
  PG_UpdateStr(m_sql,"to_date","to_timestamp",true);
...
// 把字符串中的某字符串用另一个字符串代替，函数加上PG_前缀是为了不与_public中的冲突
void PG_UpdateStr(char *in_string,const char *in_str1,const char *in_str2,bool bLoop)
{
