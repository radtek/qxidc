...
# 处理全国遥测站数据，转换为ZHOBTDATA*.xml和ALLAWSMIN_*.xml文件，用于入库到T_ZHOBTDATA和T_ALLAWSMIND表中。
...
# 从服务器上获取全国预警信号发布的文件
/htidc/htidc/bin/procctl 10 /htidc/htidc/bin/fileclient /log/wandlife/fileclient_get_alert.log "<localrootpath>/qxdata/wandlife/sdata/alert</localrootpath><dstrootpath>/home/alert</dstrootpath><url>223.4.5.165,3306</url><matchname>alert.xml</matchname><andchild>FALSE</andchild><timetvl>20</timetvl><checkcount>1</checkcount><conntype>2</conntype>"

# 处理预警信号
/htidc/htidc/bin/procctl 30 /htidc/wandlife/bin/palertfile /log/wandlife/palertfile.log wandlife/pwdidc /qxdata/wandlife/sdata/alert/alert.xml
