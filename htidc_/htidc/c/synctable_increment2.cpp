...
int main(int argc,char *argv[])
{
  ...
  //打开告警
  if (strcmp(stralarmbz,"TRUE")==0) logfile.SetAlarmOpt("synctable_increment2");

  // 注意，程序超时是1200秒
  ProgramActive.SetProgramInfo(&logfile,"synctable_increment2",1200);
...
void CallQuit(int sig)
{
  ...
  logfile.Write("synctable_increment2 exit.\n");
